...
Users interaction profiles is a profile created by Makazhanov \& Raﬁei to capture interactions between users and other accounts. \cite{pol} An interaction is a retweet or a reply. Pennacchiotti \& Popescu also uses friend accounts as a measurement in interaction between users. \cite{usermachine}  A friend account of user $x$ is an account that is followed by user $x$.  %TODO read this over, second sentence unclear 
\\\\
