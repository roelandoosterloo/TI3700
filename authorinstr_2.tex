...
Another way to classify users is by applying the Latent Dirichlet Allocation (LDA), the idea behind this model is that some class $c_0$ will probably talk more about subject $A$ than class $c_1$ %TODO Afmaken
\\\\
